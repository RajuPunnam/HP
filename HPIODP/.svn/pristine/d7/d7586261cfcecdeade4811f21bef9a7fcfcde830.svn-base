...
@Document(collection="PO_ORDERS_SKU_AV_PN")
@Entity
@Table(name="po_orders_sku_av_pn")
@Access(value=AccessType.FIELD)
public class OpenOrders_SkuAvPn {
   ...
   /* public String getPartLevel() {
	...
	public String toString() {
		return "OpenOrders_SkuAvPn [id1=" + id1 + ", fileDate=" + fileDate
				+ ", adjustedDate=" + adjustedDate + ", poRecDate=" + poRecDate
				+ ", po=" + po + ", sku=" + sku + ", pl=" + pl + ", family="
				+ family + ", avId=" + avId + ", avCons=" + avCons
				+ ", skuCons=" + skuCons + ", partId=" + partId + ", quantity="
				+ quantity + ", flag=" + flag + ", skuPrice=" + skuPrice
				+ ", avPrice=" + avPrice + ", partPrice=" + partPrice
				+ ", commodity=" + commodity + ", bu=" + bu + ", so=" + so
				+ ", SKUQty_Del=" + SKUQty_Del + ", AVQty_Del=" + AVQty_Del
				+ ", PNQty_Del=" + PNQty_Del + "]";
	}
