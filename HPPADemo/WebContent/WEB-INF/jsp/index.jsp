	...
	<div style="height: 55px;background-color: #037CD5;width: 100%;">
		<div class="container">
			<div style="padding-top: 9px;">
				<img src="Resources/app/images/hp.png">
			</div>
		</div>
	</div>
					...
					<form id="form" action="j_spring_security_check" method="POST">
                            ...
                            <c:remove var = "SPRING_SECURITY_LAST_EXCEPTION" scope = "session" />
				             ...
				             <span id="passwordErrorMessage">  </span>
								...
								<button  class="btn btn-custom1" >LOGIN</button>									
		                       ...
		                       Forgot Password ?
								...
								<div class="form-group" style="color: #8A8A8A;margin-top: 20px;">
									New to hp cleverchek ? <a href="Signup.xhtml" class="text-custom1" style="font-weight: 600;"> Signup</a>
								</div>
							</form>
						</div>
