...
public class PipeLineAvAvbail 
{
	...
	public PipeLineAvAvbail(String sku,String avId,double avbails[]) {
		super();
		this.sku = sku;
		this.avId = avId;
		this.avbail = avbails[6];
		this.avbail15 = avbails[0];
		this.avbail30 = avbails[1];
		this.avbail45 = avbails[2];
		this.avbail60 = avbails[3];
		this.avbail75 = avbails[4];
		this.avbail90 = avbails[5];
	}
